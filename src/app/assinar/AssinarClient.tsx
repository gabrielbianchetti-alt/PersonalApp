      ...
      <div style={{ textAlign: 'center', marginBottom: 40 }}>
        <div
          style={{
            ...
            borderRadius: 24, padding: '5px 16px', fontSize: 12, fontWeight: 700, color: '#00E676',
          }}
        >
        ...
        {PLANOS.map(p => (
          <div
            ...
            style={{
              ...
              border: `1.5px solid ${p.destaque ? '#00E676' : 'rgba(255,255,255,0.08)'}`,
              borderRadius: 20,
              padding: '28px 24px',
              position: 'relative',
              overflow: 'hidden',
          ...
          >
            ...
            <p style={{ fontSize: 11, color: p.destaque ? '#00E676' : '#64748b', marginBottom: 20 }}>
              {p.detalhe}
            </p>
            ...
            <button
              ...
              style={{
                ...
                background: p.destaque ? '#00E676' : 'rgba(255,255,255,0.08)',
