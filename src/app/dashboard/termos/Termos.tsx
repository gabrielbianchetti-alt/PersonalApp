        ...
        <div className="px-5 pb-5 flex gap-2 shrink-0" style={{ borderTop: '1px solid var(--border-subtle)', paddingTop: '16px' }}>
          {sent ? (
            <button
              ...
              style={{ background: 'var(--green-muted)', color: 'var(--green-primary)', border: '1px solid rgba(0,230,118,0.3)' }}
            >
              ✓ Enviado! Fechar
            </button>
          ) : (
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="text-right shrink-0 hidden sm:block">
                        {lastSend ? (
                          <>
                            <p className="text-xs font-medium" style={{ color: '#00E676' }}>✓ Enviado</p>
